...
to initialise these singletons when this listener starts as Tomcat's common
...
JRE Memory Leak Prevention Listener provides work-arounds for preventing memory
leak. "
  impact 0.5
  tag "ref": "1.
https://tomcat.apache.org/tomcat-7.0doc/config/listeners.html#JRE_Memory_Leak_Prevention_Listener__org.apache.catalina.core.JreMemoryLeakPreventionListener
"
  tag "severity": "medium"
  tag "cis_id": "10.18"
